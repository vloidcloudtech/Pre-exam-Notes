...
2. [Cloud Native Application Delivery](#cloud-native-application-delivery)
3. [Cloud Native Observability](#cloud-native-observability)
...
#### Question 4: What is Site Reliability Engineering (SRE)?
...
#### Question 5: What are the 3 vendor-neutral container standards that the Open Container Initiative (OCI) provides?
...
#### Question 3: What does Continuous Deployment mean in CI/CD?
...
#### Question 3: Which of the following statements best describes what Prometheus is?
...
#### Question 5: Which of the following is not a type of telemetry data that is used as a signal in OpenTelemetry?
...
#### Question 3: What are the different telemetry data that OpenTelemetry can create and manage?
...
#### Question 4: You are developing an eLearning application that will run on a Kubernetes cluster. Which of the following is the most operationally-efficient way to implement tracing?
...
#### Question 9: Which of the following metric types in Prometheus represents a single numerical value that can arbitrarily increase and decrease over time?
...
#### Question 1: Which of the following should you use to request storage in a Kubernetes cluster?
...
#### Question 4: How can you configure a Service to be reachable only from within the Kubernetes cluster?
...
#### Question 7: Which of the following is a type of a namespaced object?
...
#### Question 9: Which of the following provides an internal alias for an external DNS name?
...
#### Question 3: Which of the following is true regarding the LoadBalancer Service type?
...
#### Question 5: Which of the following acts as an entry point for your Kubernetes cluster and lets you consolidate your routing rules into a single resource?
...
#### Question 7: Which of the following is not included in the set of initial namespaces that Kubernetes starts by default?
...
#### Question 12: What is the common built-in autoscaling on Kubernetes that can be easily created using the kubectl autoscale command?
...
#### Question 14: Which of the following statements best describes RuntimeClass?
...
#### Question 17: Which of the following statements is true regarding Service Accounts?
...
#### Question 20: What can you use to provide an identity for the processes that run in your Pods?
...
#### Question 21: Which of the following statements is NOT a valid description of Service Accounts?
...
#### Question 22: What should you do to grant cross-namespace access to Pods?
...
#### Question 7: Which of the following is NOT a valid phase of a Pod in Kubernetes?
...
#### Question 8: Which of the following is not a service type in Kubernetes?
...
#### Question 13: Which Kubernetes command can be used to login to a pod via SSH?
...
#### Question 17: Which control plane component links your Kubernetes cluster into your cloud provider's API?
...
#### Question 20: What can you use to provide an identity for processes that run in your Pods?
...
#### Question 23: Which command describes the supported API resource and all its associated fields?
...
#### Question 3: Which of the following provides containers with automatic bin packing?
...
#### Question 5: Which of the following is a type of Kubernetes Service?
...
#### Question 7: Which command should you use to deploy a new Deployment object?
...
#### Question 11: Which statement is true regarding the etcd key-value store?
...
#### Question 13: Which is not a valid type of probe in Kubernetes?
...
#### Question 14: Which lists are valid Cloud Controller Manager functions?
...
#### Question 15: What does `kubectl exec tutorials -c dojo -- date` do?
...
#### Question 17: Which acts as the front end for the Kubernetes control plane?
...
#### Question 18: What is true regarding kubectl describe vs kubectl explain commands?
