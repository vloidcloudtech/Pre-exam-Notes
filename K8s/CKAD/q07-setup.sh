...
# Setup: namespace network-demo with 3 pods (wrong labels) and 3 NetworkPolicies
set -euo pipefail
...
echo "✅ Q7 setup complete. 3 pods with wrong labels, 3 NetworkPolicies in namespace network-demo."
